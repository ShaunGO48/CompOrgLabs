...
%~\ref{code:regtest} on page~\pageref{code:regtest}.
...
Lastly, we were curious as to the functionality of the reset command, which we hoped would reset the 32-bit register to a value of zero. While initially we did have problems with the syntax of the command, a timing diagram depicting the success of these three situations can be found in %Figure~\ref{fig:regtestr} on page~\pageref{fig:regtestr}. 
